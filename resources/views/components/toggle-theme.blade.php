<div  class="flex items-center justify-center ">
    <button
      class="w-16 h-8 bg-yellow-200 rounded-full p-1 flex items-center dark:bg-blue-200"
      @click="$store.darkMode.toggle()"
    >
      <div
        class="w-6 h-6 bg-yellow-400 rounded-full shadow-md dark:bg-blue-400 transition duration-500 ease-in-out"
        :class="$store.darkMode.dark && 'transform translate-x-8 bg-gray-700'"
      >
        <svg  
        x-show="$store.darkMode.dark"
